...
values_hbf_coeff20 = (
    pd.read_csv(
        "transformer_A100_HBF_sim_HBF_coeff20.csv",
        header=None,
        names=categories,
        index_col=None,
    )
...
# HBF coeff20
bottom = 0
for i, (category, value) in enumerate(zip(categories, values_hbf_coeff20)):
    plt.bar(3, value, bottom=bottom, color=colors[i], width=0.5)
    bottom += value
sum_hbf_coeff20 = bottom

print(
    f"Init total (s): A100-excl={sum_a100_excl:.4f}, A100={sum_a100:.4f}, HBF_coeff20={sum_hbf_coeff20:.4f}"
)
print(
    f"Init speedups: excl/HBF_coeff20={sum_a100_excl / sum_hbf_coeff20:.3f}x, A100/HBF_coeff20={sum_a100 / sum_hbf_coeff20:.3f}x"
)
...
values_ar_hbf_coeff20 = (
    pd.read_csv(
        "transformerAR_A100_HBF_sim_coeff20.csv",
        header=None,
        names=categories,
        index_col=None,
    )
...
# HBF coeff20 (ms)
bottom = 0
for i, (category, value) in enumerate(zip(categories, values_ar_hbf_coeff20)):
    value_ms = value * 1e3
    plt.bar(3, value_ms, bottom=bottom, color=colors[i], width=0.5)
    bottom += value_ms
sum_ar_hbf_coeff20 = bottom

print(
    f"AR total (ms): A100-excl={sum_ar_a100_excl:.2f}, A100={sum_ar_a100:.2f}, HBF_coeff20={sum_ar_hbf_coeff20:.2f}"
)
print(
    f"AR speedups: excl/HBF_coeff20={sum_ar_a100_excl / sum_ar_hbf_coeff20:.3f}x, A100/HBF_coeff20={sum_ar_a100 / sum_ar_hbf_coeff20:.3f}x"
)
