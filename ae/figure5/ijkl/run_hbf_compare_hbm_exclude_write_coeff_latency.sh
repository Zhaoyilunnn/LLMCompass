...
python -m ae.figure5.ijkl.test_transformer --simgpu-hbf --fixed-io-write-coeff 33 --fixed-latency 3e-6
...
python -m ae.figure5.ijkl.test_transformer --simgpu-hbf --init --fixed-io-write-coeff 33 --fixed-latency 3e-6
...
cd ae/figure5/ijkl
python plot_transformer_hbf_compare_write_coeff_latency.py
